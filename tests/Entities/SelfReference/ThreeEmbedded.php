...
class ThreeEmbedded extends Entity implements SyntheticEntity, StrictlyFilledEntity
{
    /**
     * @var FourEmbedded
     */
...
class ThreeEmbeddedMap extends Mapper
{
    /**
     * @var Column
     */
     ...
     * @var Embedded
     */
    protected $FourEmbedded = [
        Embedded::NAME => "four",
        Embedded::ENTITY_CLASS => FourEmbedded::class,
